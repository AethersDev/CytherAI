...
| Producer binding | The pixels come from the repository's substrate kernel, not a second renderer: `js/manifest.js` sha256 `df0ad2da86d3011a4e86dcf7c5b42498acdfb67cc084e27d3abeb286bef6e20b`, `js/substrate.js` sha256 `3848dd44ffefda76c1d794bd23485986d266a9978129c7b6912318ecf1f25008`, `tools/promote-poster.js` sha256 `79f7c2e1ab45377fe1713e6c83880b5a0a3a78b4b943ecb08b0275f66811cee2`. The Python step is a lossless container writer and receipt printer; it computes no pixel. |
...
| Method | Plate 0 (`ZOOMS[0]` 1.3, `PLATE[0]` anchor inks, rot 0.12) developed by `developStep` at the fixed `DEV_BATCH` of 60,000 iterations to its terminal state, then `tonemapInto` — the same function the page calls, normalized log density with no gamma since `docs/audit/07` — into a `Uint8ClampedArray`, whose round-half-even clamping is part of the exposure law. Every recurrence is `dsin`/`dcos`/`datan2` (§8.1), so D_N and R_N are engine-invariant: jsc and Chrome produce the identical raster (measured 2026-09-09, rgba FNV `5f13f462` at a 800×343 probe frame). |
...
| Terminal raster R_N | 1200×600 RGBA · sha256 `8470177b2310988182af9cc70746fb34854aa5b901f5ae878c71b94d07167663` |
...
| Output | `assets/plate/surface-terminal.png` · 1200×600 · 393,585 bytes |
| SHA-256 | `995544f11650889c2867c910e840c850a845629e9fef67cc3bfff053e82699b9` |
